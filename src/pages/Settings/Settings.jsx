...
import { Building2, Map, Sliders, Plus, Edit, Trash2, Loader2, CheckCircle, X, Save, MapPin } from 'lucide-react';
...
export default function Settings() {
  ...
  return (
    <div className="flex flex-col gap-4 animate-in fade-in duration-300 h-full w-full max-w-4xl mx-auto">
      ...
      {/* 🪄 MENÚ DE PESTAÑAS (Corregido y Compacto) */}
      ...
      <div className="bg-surface rounded-2xl shadow-sm border border-slate-100 overflow-hidden flex-1">
        ...
        {/* 1. PESTAÑA: INFORMACIÓN UNIVERSIDAD */}
          ...
          <div className="p-5 sm:p-8 flex flex-col h-full animate-in fade-in">
            ...
            {sedes.length === 0 ? (
              <div className="flex-1 flex flex-col items-center justify-center text-slate-400 border-2 border-dashed border-slate-100 rounded-xl py-10 bg-slate-50/50">
                ...
                <p className="text-xs mt-1">Haz clic en "Nueva Sede" para empezar.</p>
              </div>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {sedes.map((sede) => (
                  <div key={sede.id} className="bg-white border border-slate-200 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow relative group">
                    ...
                    {/* 🪄 AQUÍ ESTABA EL ERROR: MapPin ya está importado */}
            ...
            <div className="max-w-2xl">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex items-center justify-between p-3.5 bg-red-50/50 border border-red-100 rounded-xl">
                  <div>
                    <h4 className="font-bold text-red-700 text-sm">Modo Mantenimiento</h4>
                    <p className="text-[11px] text-red-500/80 mt-0.5">Desactiva el escáner para todos los usuarios.</p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
